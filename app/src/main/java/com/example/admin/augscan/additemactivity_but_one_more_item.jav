...
public class additemActivity extends AppCompatActivity {
    private EditText itemname,itemcategory,itemprice, storagesite;
    ...
    String[] strings = {"RBC","Glucose","Creatinine","Urea"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storagesite = findViewById(R.id.storagesite);
...
public  void additem(){
        String storagesitevalue = storagesite.getText().toString();
        String itemnameValue = itemname.getText().toString();
        String itemcategoryValue = autoCompleteTextView.getText().toString();
    ...
    if(!TextUtils.isEmpty(itemnameValue)&&!TextUtils.isEmpty(itemcategoryValue)&&!TextUtils.isEmpty(itempriceValue)){
        ...
        Items items = new Items(itemnameValue,itemcategoryValue,itempriceValue,itembarcodeValue, storagesitevalue);
